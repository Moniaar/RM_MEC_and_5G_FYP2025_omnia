...
class MECServer:
    ...
    def simulate_training_round(self, selected_devices, epochs=3):
        ...
        with open("training_round_output.txt", "a") as f:
            f.write(f"Num Valid Devices: {len(local_weights)}\n")
        return max(delays) if delays else 0, total_energy, total_bandwidth
